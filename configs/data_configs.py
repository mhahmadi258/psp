...
DATASETS = {
	...
	'babapour_frontalize': {
		'transforms': transforms_config.FrontalizationTransforms,
		'train_source_root': dataset_paths['babapour'],
		'train_target_root': dataset_paths['babapour'],
		'test_source_root': dataset_paths['babapour'],
		'test_target_root': dataset_paths['babapour'],
	},
